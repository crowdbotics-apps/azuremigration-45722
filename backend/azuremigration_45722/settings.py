"""
Django settings for azuremigration_45722 project.
...
ROOT_URLCONF = 'azuremigration_45722.urls'
...
WSGI_APPLICATION = 'azuremigration_45722.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "azuremigration_45722 API",
    "DESCRIPTION": "API documentation for azuremigration_45722 App",
    "VERSION": "v1",
}
